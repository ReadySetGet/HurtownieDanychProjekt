...
CREATE TABLE PAs
(
	PA_ID INTEGER IDENTITY(0,1) PRIMARY KEY,
...
(
    Ad_proc_ID INTEGER IDENTITY(0,1) PRIMARY KEY,
...
(
	Questionnaire_ID INTEGER IDENTITY(0, 1) PRIMARY KEY,
	Questionnaire_nr INTEGER NOT NULL,
	PA_ID INTEGER FOREIGN KEY REFERENCES PAs NOT NULL,
...
(
	Adoption_ID INTEGER IDENTITY(0, 1) PRIMARY KEY,
	Certificate_nr BIGINT,
	Ad_proc_ID INTEGER FOREIGN KEY REFERENCES Adoption_processes NOT NULL,
