...
import static vidvana.happypuppy.simulation.Simulator.*;
...
public class Person implements Entity {
    ...
    public void actionAdopt() {
        if (RANDOM.nextDouble(1.0) <= (double) PROCESSES_PER_DAY/sim.getPeopleSize()  && sim.getAnimalsAvailableSize() > 0) {
